...
public class IterativeForwardListTest {
    IterativeForwardList<Integer> list;

    @Before
    public void setUp() {
        list = new IterativeForwardList<>();
    }
    ...
    public void test_060_static_factory_of_empty() {
        list = IterativeForwardList.of();
        assertEquals(0, list.size());
    }

    @Test
    public void test_070_static_factory_of_one() {
        list = IterativeForwardList.of(10);
        assertEquals(1, list.size());
    }

    @Test
    public void test_080_static_factory_of_many() {
        list = IterativeForwardList.of(10, 20, 30);
    ...
    public void test_090_after_append_empty_list_is_still_empty() {
        assertTrue(list.empty());
        IterativeForwardList<Integer> list2 = new IterativeForwardList<>();
        list.append(list2);
        assertTrue(list.empty());
    }
    ...
    public void test_100_after_append_list_is_not_empty() {
        ...
        IterativeForwardList<Integer> list2 = IterativeForwardList.of(10);
        list.append(list2);
        assertEquals(1, list.size());
        // create and append another list: NOT list2 as would introduce a cycle
        IterativeForwardList<Integer> list3 = IterativeForwardList.of(20, 30);
        list.append(list3);
        assertEquals(3, list.size());
    }
    ...
    public void test_150_empty_lists_are_equal() {
        ...
        IterativeForwardList<Integer> list2 = IterativeForwardList.of();
    ...
    public void test_200_delete_list_items_forwards() {
        list = IterativeForwardList.of(1, 2, 3);
        assertTrue(list.equals(IterativeForwardList.of(1, 2, 3)));
        list.delete(1); assertTrue(list.equals(IterativeForwardList.of(2, 3)));
        list.delete(2); assertTrue(list.equals(IterativeForwardList.of(3)));
        list.delete(3); assertTrue(list.equals(IterativeForwardList.of()));
    }
    ...
    public void test_210_delete_list_items_backwards() {
        list = IterativeForwardList.of(1, 2, 3);
        assertTrue(list.equals(IterativeForwardList.of(1, 2, 3)));
        list.delete(3); assertTrue(list.equals(IterativeForwardList.of(1, 2)));
        list.delete(2); assertTrue(list.equals(IterativeForwardList.of(1)));
        list.delete(1); assertTrue(list.equals(IterativeForwardList.of()));
    }
    ...
    public void test_220_delete_item_from_list_internally() {
        list = IterativeForwardList.of(1, 2, 3);
        assertTrue(list.equals(IterativeForwardList.of(1, 2, 3)));
        list.delete(2); assertTrue(list.equals(IterativeForwardList.of(1, 3)));
    }
    ...
    public void test_250_reverse_list_pair() {
        list = IterativeForwardList.of(10, 20);
    ...
    public void test_270_reverse_big_list() {
        list = IterativeForwardList.of(10, 20, 30, 40, 50);
        assertTrue(list.size() == 5);
        list.reverse();
        assertTrue(list.size() == 5);
        assertTrue(list.equals(IterativeForwardList.of(50, 40, 30, 20, 10)));
    }
    ...
    public void test_280_reversed_empty_list_is_still_empty() {
        assertTrue(list.empty());
        IterativeForwardList<Integer> result = list.reversed();
    ...
    public void test_320_reversed_big_list() {
        ...
        assertTrue(result.equals(IterativeForwardList.of(50, 40, 30, 20, 10)));
    }
